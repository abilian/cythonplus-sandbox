...
cdef cypclass StaticFile:
    ...
    Response get_response(self, Sdict request_headers):
    ...
    bint is_not_modified(self, Sdict request_headers):
    ...
    Alternative get_path_and_headers(self, Sdict request_headers):
