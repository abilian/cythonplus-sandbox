...
version_string = VERSION_RE.search(read("cyp_min_whitenoise/__init__.py")).group(1)
...
extensions = [
    py_ext("cyp_min_whitenoise", "base"),
    py_ext("cyp_min_whitenoise", "compress"),
    py_ext("cyp_min_whitenoise", "django"),
    py_ext("cyp_min_whitenoise", "media_types"),
    py_ext("cyp_min_whitenoise", "middleware"),
    py_ext("cyp_min_whitenoise", "responders"),
    py_ext("cyp_min_whitenoise", "storage"),
    py_ext("cyp_min_whitenoise", "string_utils"),
]
